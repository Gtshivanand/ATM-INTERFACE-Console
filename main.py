"""ATM Interface using  three-way model of A Bank system A user,An Admin and ATm console """
...
class Bank(Frame):
    ...
    def main(self):
        ...
        Label(self,text = "WELCOME TO THE UNIVERSITY OF VSM ATM",fg = "yellow",
              relief = RAISED,bg = "black",borderwidth = 10,height = 2,padx = 3,pady = 3,
              width = 46,font = "Calibri").grid()
        
        Button(self,text = "Click To Enter As Admin",bg = "silver",fg = "black",width = 40,
               height = 2,command = self.AdminStart,activeforeground = "red").grid(sticky = W+S,pady = 10,padx = 5)
        
        Button(self,text = "Click To Enter As User",bg = "silver",fg = "black",width = 40,
